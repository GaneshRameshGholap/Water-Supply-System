...
<h1 align="center" style='background:black;color:white;padding:10px;'>WELCOME ADMIN</h1>
<br><br><br>
<center>
	<button onclick="location.href='add_products.jsp'" class='btn'>MANAGE PRODUCTS</button>&nbsp;
	<button onclick="location.href='manage_orders.jsp'" class='btn'>VIEW ORDERS</button>
